  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Free online calculators for finance, health, education, math, and more. Easy to use and accurate calculations for all your needs."
        />
      </Helmet>
      <Layout>
        <Routes>
          ...
          <Route
            ...
            element={<SquareFootageCalculator />}
          />
          <Route
            path="/mortgage-payoff-calculator"
            element={<MortgagePayoffCalculator />}
          />
          <Route
          ...
          <Route
            ...
            element={<BoatLoanCalculator />}
          />
          <Route
            path="/pay-raise-calculator"
            element={<PayRaiseCalculator />}
          />
          <Route
          ...
          <Route
            ...
            element={<PuppyWeightCalculator />}
          />
          <Route path="/macro-calculator" element={<MacroCalculator />} />
          <Route
            path="/betting-odds-calculator"
            element={<BettingOddsCalculator />}
          />
          ...
          <Route
            ...
            element={<VADisabilityCalculator />}
          />
          <Route
            path="/pizza-dough-calculator"
            element={<PizzaDoughCalculator />}
          />
          <Route
            path="/graduation-year-calculator"
            element={<GraduationYearCalculator />}
          />
          ...
          <Route
            ...
            element={<SocialSecurityCalculator />}
          />
          <Route
          ...
          <Route
            ...
            element={<SpecificHeatCalculator />}
          />
          <Route
            path="/roof-pitch-calculator"
            element={<RoofPitchCalculator />}
          />
          ...
          <Route
            ...
            element={<DownloadTimeCalculator />}
          />
          <Route
            path="/chemistry-calculator"
            element={<ChemistryCalculator />}
          />
          <Route
          ...
          <Route
            ...
            element={<PlantSpacingCalculator />}
          />
          ...
          <Route
            ...
            element={<WeddingCashGiftCalculator />}
          />
          ...
          <Route
            ...
            element={<PokerOddsCalculator />}
          />
          <Route
            path="/wronskian-calculator"
            element={<WronskianCalculator />}
          />
