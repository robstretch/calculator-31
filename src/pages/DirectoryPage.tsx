...
export function DirectoryPage() {
  return (
    <div className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
      <SEO
        title="Calculator Directory | Browse All Calculators"
        description="Browse our complete directory of free online calculators. Find tools for finance, health, education, math, construction, sports, and lifestyle calculations."
        keywords={[
